            ...
            modalBody.innerHTML = `
                <div class="mindmap-demo">
                    ...
                    <div class="mindmap-content">
                        ...
                        <img src="/ai-tools/mindmap-demo/page6.SVG" alt="AI工具使用说明思维导图 - 第6页" onerror="handleImageError(this)">
                    </div>
                </div>
            `;
            break;
        case 'ppt':
            ...
            modalBody.innerHTML = `
                <div class="mindmap-demo">
                    ...
                    <div class="mindmap-content">
                        <img src="/ai-tools/ppt-demo/page1.SVG" alt="PPT示例 - 第1页" onerror="handleImageError(this)">
                        <img src="/ai-tools/ppt-demo/page2.SVG" alt="PPT示例 - 第2页" onerror="handleImageError(this)">
                        <img src="/ai-tools/ppt-demo/page3.SVG" alt="PPT示例 - 第3页" onerror="handleImageError(this)">
                    </div>
                </div>
            `;
            break;
        case 'flowchart':
            ...
            modalBody.innerHTML = `
                <div class="mindmap-demo">
                    ...
                    <div class="mindmap-content">
                        <img src="/ai-tools/flowchart-demo/page1.SVG" alt="流程图示例 - 第1页" onerror="handleImageError(this)">
                        <img src="/ai-tools/flowchart-demo/page2.SVG" alt="流程图示例 - 第2页" onerror="handleImageError(this)">
                        <img src="/ai-tools/flowchart-demo/page3.SVG" alt="流程图示例 - 第3页" onerror="handleImageError(this)">
                    </div>
                </div>
            `;
            break;
        case 'prompt':
            ...
            modalBody.innerHTML = `
                <div class="demo-content">
                    <img src="/ai-tools/images/prompt-demo.svg" alt="Prompt优化示例" style="width: 100%; max-width: 800px;">
